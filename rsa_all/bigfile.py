...
from rsa_all import key, common, pkcs1, varblock
from rsa_all._compat import byte
...
def encrypt_bigfile(infile, outfile, pub_key):
    ...
    :param pub_key: :py:class:`rsa_all.PublicKey` to encrypt with
...
def decrypt_bigfile(infile, outfile, priv_key):
    ...
    :param priv_key: :py:class:`rsa_all.PrivateKey` to decrypt with
